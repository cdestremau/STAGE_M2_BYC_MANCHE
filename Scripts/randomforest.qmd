...
# Join species_weight for the second most fished species
...
# Join species_weight for the third most fished species
...
# Join the second and third species information with other summary statistics
...
#paw3 <- paw3[complete.cases(paw3[["Bycatch"]]), ]

#Bycatch needs to be as.factor since we want to do classif
...
maree_summary$Bycatch <- as.numeric(maree_summary$Bycatch)
