...
marsouin_SAMM_I_summer <- dauphin %>%
  filter(session_global == "SAMM_1_summer")
marsouin_SAMM_I_winter <- dauphin %>%
  filter(session_global == "SAMM_1_winter")
marsouin_SAMM_II_winter <- dauphin %>%
  filter(session_global == "SAMM_2_winter")
marsouin_SCANS_III_summer <- dauphin %>%
  filter(session_global == "SCANS_3_summer")
...
SAMM_I_summer <- st_intersection(effort_SAMM_I_summer, marsouin_SAMM_I_summer)
SAMM_I_winter <- st_intersection(effort_SAMM_I_winter, marsouin_SAMM_I_winter)
SAMM_II_winter <- st_intersection(effort_SAMM_II_winter, marsouin_SAMM_II_winter)
SCANS_III_summer <- st_intersection(effort_SCANS_III_summer, marsouin_SCANS_III_summer)
